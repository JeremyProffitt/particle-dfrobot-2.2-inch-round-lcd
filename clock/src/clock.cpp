...
#include "Particle.h"
#line 1 "c:/dev/particle-round-lcd/DFRobot_ST7687S/examples/clock/clock/src/clock.ino"
/*
 * file clock.ino
 *
...
void setup(void);
void loop(void);
#line 30 "c:/dev/particle-round-lcd/DFRobot_ST7687S/examples/clock/clock/src/clock.ino"
#ifdef __AVR__
